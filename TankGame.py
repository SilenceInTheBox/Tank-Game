...
class PhysicsSim():
    ...
    def createGround(self,world):
        ...
        y = np.array(ground.create_ground([world.ground_height,world.ground_height],world.xdim))
        y = 0.8 * world.ydim * y
...
# print(p1.getPos())
# print(p2.getPos())
canvas.create_rectangle(p1.getPos()[0]-5, world.ydim-p1.getPos()[1], p1.getPos()[0]+5, world.ydim-p1.getPos()[1]-10,fill='green')
canvas.create_rectangle(p2.getPos()[0]-5, world.ydim-p2.getPos()[1], p2.getPos()[0]+5, world.ydim-p2.getPos()[1]-10,fill='red')
print(p1.name)
